module params
    ...
    integer(kind=k15), parameter :: lmax = 2E5
    ...
    integer, parameter :: nsys = 2, model = 3
    real(kind=wp1), parameter :: gamma = half * (sqrt(three) - one)
    real(kind=wp1), parameter :: dt = 0.0004_wp1, dt2 = dt*dt, &
                                 dt205 = dt2*half, dthalf = dt * half
    integer, parameter :: tlen = nint(15.0_wp1/dt)
    ...
    real(kind=wp1), parameter ::  lambda = 0.75_wp1
    real(kind=wp1), parameter :: capomega = atan(30.0_wp1)
    real(kind=wp1), parameter :: beta = 0.25 !!
    real(kind=wp1), parameter :: e11 = 1.5_wp1 * omegac, j12 = 1.0_wp1 * omegac
    ...
    real(kind=wp1), parameter :: tol = 0.01_wp1
